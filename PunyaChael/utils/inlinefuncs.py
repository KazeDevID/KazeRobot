...
from PunyaChael import pbot as app 
from PunyaChael import arq
from PunyaChael.services.keyboard import Ikb
from PunyaChael.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from PunyaChael.services.tasks import _get_tasks_text, all_tasks, rm_task
from PunyaChael.services.types import InlineQueryResultCachedDocument
from PunyaChael.modules.info import get_chat_info, get_user_info
from PunyaChael.modules.music import download_youtube_audio
from PunyaChael.utils.functions import test_speedtest
from PunyaChael.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Kaze91_Bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Developer ❤️](https://t.me/KenalSayaaa):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
