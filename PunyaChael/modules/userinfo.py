...
from PunyaChael.__main__ import STATS, TOKEN, USER_INFO
from PunyaChael.modules.sql import SESSION
import PunyaChael.modules.sql.userinfo_sql as sql
from PunyaChael.modules.disable import DisableAbleCommandHandler
from PunyaChael.modules.sql.global_bans_sql import is_user_gbanned
from PunyaChael.modules.sql.afk_sql import is_afk, set_afk
from PunyaChael.modules.sql.users_sql import get_user_num_chats
from PunyaChael.modules.helper_funcs.chat_status import sudo_plus
from PunyaChael.modules.helper_funcs.extraction import extract_user
from PunyaChael import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
    elif user.id == 2135624454:
         text += "\n\nOwner Of A Bot. Queen Of @KenalSayaaa. Bot Name Inspired From 'Kaze'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://telegra.ph/HEAL-By-Kaze-04-05"),
                            InlineKeyboardButton(
                                "Creator", url="https://t.me/KenalSayaaa"),
                            InlineKeyboardButton(
                                "Support", url="https://t.me/NothingSupportBot")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
*What is that health thingy?*
 Come and see [HP System explained](https://telegra.ph/HEAL-By-Kaze-04-05)
"""
